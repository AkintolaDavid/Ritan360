      ...
      <div className="SerBrandingmaincontainer">
        ...
        <div className="servicedropdownsecond">
          <span className="servicedropdownsecondone">
            Ritan360 Technologies offers the best of SEO and Digital Marketing
            to ensure your business stands out; If you want to improve your
            website rankings and drive more focused traffic to your page, trust
            our SEO team with exclusive SEO packages to give your business the
            right start.
          </span>
          <span className="servicedropdownsecondone">
            We understand the importance of not just improving the volume of
            your website traffic, but also enhancing the quality of your
            traffic. High-quality traffic that will help in boosting your
            business and enhances overall business growth. In simple words.{" "}
          </span>
          <span className="servicedropdownsecondone">
            ...
            manner. Our professional Lagos SEO and digital marketing services
            make it possible for your company to present your message uniquely
            and powerfully. With our expertise, your brand will get noticed in
            no time!
          </span>
          <span className="servicedropdownsecondone">
        ...
        <div className="servicedropdownthird">
          ...
          <div className="servicedropdownthirditems">
            ...
            <div className="servicedropdownthirditem">
              <FiCheckSquare className="eeeee" />
              <span className="servicedropdownthirditemstext">
                We finally get to design all the ad assets and ad copy base on
                the ideas shared or list of all the SEO materials we indeed to
                work with.{" "}
              </span>
            </div>
            <div className="servicedropdownthirditem">
              <FiCheckSquare className="eeeee" />
              <span className="servicedropdownthirditemstext">
                We share the final ads assets and copy with your for accuracy
                and the list of channels we indeed to use.
              </span>
            </div>
            <div className="servicedropdownthirditem">
              <FiCheckSquare className="eeeee" />
              <span className="servicedropdownthirditemstext">
                Once approved, your ads will be submitted and if it's just SEO
                we commence the process immedately.
              </span>
            </div>
            <div className="servicedropdownthirditem">
              <FiCheckSquare className="eeeee" />
              <span className="servicedropdownthirditemstext">
                ...
                tracking, clicks and other reports will then be shared with you
                in due time.
              </span>
            </div>
          </div>
