      ...
      <div className="SerBrandingmaincontainer">
        ...
        <div className="servicedropdownsecond">
          <span className="servicedropdownsecondone">
            We pride ourselves in developing mobile apps that are specific to
            your business requirements and accelerate your business’ online
            marketing plan. We ensure that the app design is also in sync with
            your brand image and offers an easy-to-use and navigation user
            interface.
          </span>
          <span className="servicedropdownsecondone">
          ...
          <span className="servicedropdownsecondone">
            Wouldn’t you rather be where your customers are? then it’s time to
            get your mobile app up and running, already have a website? super
            great as the mobile app will be a great investment to compliment it.{" "}
          </span>
          <span className="servicedropdownsecondone">
        ...
        <div className="servicedropdownthird">
          ...
          <div className="servicedropdownthirditems">
            ...
            <div className="servicedropdownthirditem">
              <FiCheckSquare className="eeeee" />
              <span className="servicedropdownthirditemstext">
                Our creative app team converts the approved UI/UX into codes
            ...
            <div className="servicedropdownthirditem">
              <FiCheckSquare className="eeeee" />
              <span className="servicedropdownthirditemstext">
                Once the design is created into codes, we move into connecting
                all the backend features and core functionalities for your app.{" "}
              </span>
            </div>
            <div className="servicedropdownthirditem">
              <FiCheckSquare className="eeeee" />
