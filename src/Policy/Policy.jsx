      ...
      <div className="policycontainer">
        ...
        <div className="policytextcontainer">
          <span className="policytext">
            {" "}
            Your privacy is important to us. It is Ritan360 Technologies’ policy
            to respect your privacy regarding any information we may collect
            from you across our website, https://ritan360.com, and other sites
            we own and operate.
          </span>
          <span className="policytext">
        ...
        <span className="policytext">
          By accessing the website at https://ritan360.com, you are agreeing to
        ...
        <div className="policylicense">
          ...
          <span className="policytext">
            ...
            these restrictions and may be terminated by Ritan360 Technologies at
        ...
        <span className="policytext">
          In no event shall Ritan360 Technologies or its suppliers be liable for
          ...
          inability to use the materials on Ritan360 Technologies’ website, even
          if Ritan360 Technologies or a Ritan360 Technologies authorized
        ...
        <span className="policytext">
          ...
          Technologies does not warrant that any of the materials on its website
          are accurate, complete or current. Ritan360 Technologies may make
          changes to the materials contained on its website at any time without
          notice. However Ritan360 Technologies does not make any commitment to
          update the materials.
        </span>
        <span className="policysubheader">6. Links</span>
        <span className="policytext">
          Ritan360 Technologies has not reviewed all of the sites linked to its
          website and is not responsible for the contents of any such linked
          site. The inclusion of any link does not imply endorsement by Ritan360
