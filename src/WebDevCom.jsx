      ...
      <div className="SerBrandingmaincontainer">
        ...
        <div className="servicedropdownsecond">
          <span className="servicedropdownsecondone">
            Ritan360 Technologies is your creative web development agency base
            in Lagos, Nigeria. Are you looking for web development services in
          ...
          <span className="servicedropdownsecondone">
            ...
            standards of development (Phases, Methodologies, Process, and
            Models) in line with the Software Development Life Cycle and models.
          </span>
          <span className="servicedropdownsecondone">
            We work with you all the way in the project to ensure it meets the
            requirement and engage the services of professional testers check
            our works.{" "}
          </span>
          <span className="servicedropdownsecondone">
            Our professional team at Ritan360 Technologies ensures that your
            project is not just one of the everyday solution but rather a
            solution that truly works across-platform, easy to navigate and user
            friendly. Talk to us today as your choice Web development team in
            Lagos, Nigeria.
          </span>
        </div>
