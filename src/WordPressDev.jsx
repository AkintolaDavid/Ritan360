    ...
    <div className="SerBrandingmaincontainer">
      ...
      <div className="servicedropdownsecond">
        <span className="servicedropdownsecondone">
          Ritan360 Technologies has been delivering world-class solutions in the
          construction and building of WordPress sites that delight businesses
          and attract customers. We mix user experience, custom plug-ins, and
          cutting-edge technology to diversify your project and provide the best
          online solution. Whether you own an e-commerce website or own a simple
          website where you provide services to people, we provide high
          end-to-end solution to highlights your products or services and how it
          can bring a change in their lives.{" "}
        </span>
        <span className="servicedropdownsecondone">
          We understand and respect that every business is unique, and every
          organization has unique website demands, which is why we can work with
          you to adapt WordPress to best fit your needs. Not sure what you
          require? Our WordPress professionals may make recommendations
          depending on your industry and specifics.{" "}
        </span>
        <span className="servicedropdownsecondone">
          Our professional team at Ritan360 Technologies ensures your WordPress
          website is built to fit across-platform, easy to navigate and user
          friendly. Talk to us today as your choice WordPress developer in
          Lagos, Nigeria to start with your website now.
        </span>
      </div>
