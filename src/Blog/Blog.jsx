      ...
      <div className="blogcontainer">
        <div className="blog">
          ...
          <span className="blogtext">
            WhatsApp Business App for small businesses is finally launched. The
            New Year is filled with so much expectation and excitement. For us,
            at Ritan360 Technologies
          </span>
        ...
        <div className="blog">
          ...
          <span className="blogtext">
            ...
            change without a developer editing its source code, while a dynamic
            website can{" "}
          </span>
          <button className="blogBTN">READ MORE</button>
        </div>
        <div className="blog">
          ...
          <span className="blogtext">
            In a fast-paced world where everything is instant, people no longer
            have the luxury of time for looking in a phone book or asking
            friends
          </span>
          <button className="blogBTN">READ MORE</button>
        </div>{" "}
        <div className="blog">
          ...
          <span className="blogtext">
            ...
            some website owners, but it’s the first thing your visitors notice.
            It is official: Google
          </span>
          <button className="blogBTN">READ MORE</button>
        </div>
        <div className="blog">
          <img src={pic} />
          <span className="blogcategory">Business, News, Technology</span>
          <span className="blogheader">Why you must Market your Business </span>
          <span className="blogsubheader">
