      ...
      <div className="SerBrandingmaincontainer">
        ...
        <div className="servicedropdownsecond">
          ...
          <span className="servicedropdownsecondone">
            ...
            representation of your product and services. At Ritan360
            Technologies we work towards initiating the establishment of your
            business firmly in its niche market with the use of collective
            branding and promotional tools.
          </span>
          <span className="servicedropdownsecondone">
            We use branding solutions such as logos, slogans, posters, graphical
            representation, flyers, images, videos, banners, business cards etc
            to portray your business in the best possible way to a wide
            audience. We create well researched and target branding campaigns
            that communicate the values and attributes of your company to the
            target audience.
          </span>
          <span className="servicedropdownsecondone">
        ...
        <div className="servicedropdownthird">
          ...
          <div className="servicedropdownthirditems">
            ...
            <div className="servicedropdownthirditem">
              <FiCheckSquare className="eeeee" />
              <span className="servicedropdownthirditemstext">
                We create an brand assets blueprint that gives you an idea of
                how your brand will appear on various layouts.
              </span>
            </div>
            <div className="servicedropdownthirditem">
              <FiCheckSquare className="eeeee" />
            ...
            <div className="servicedropdownthirditem">
              <FiCheckSquare className="eeeee" />
              <span className="servicedropdownthirditemstext">
                Finally your brand is set to meet the world with a creatively
                new look.
              </span>
            </div>
          </div>
