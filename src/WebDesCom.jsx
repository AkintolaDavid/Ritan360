  ...
  return (
    <div className="SerBrandingmaincontainer">
      ...
      <div className="servicedropdownsecond">
        ...
        <span className="servicedropdownsecondone">
          Our web designs are team are also in sync with the changing technology
          of the times. We design websites that are robust and can be accessed
          easily on multiple devices across a variety of platforms. They are
          quick to load, easily adjust to screen size and offer you an
